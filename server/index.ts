...
// Railway environment variable validation - log at startup (v2)
...
(async () => {
  ...
  // Use Railway's PORT env var if available, otherwise default to 5000 for Replit
  // Railway injects PORT at runtime, Replit uses 5000
